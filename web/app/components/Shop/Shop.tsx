...
export function Shop({ items }: { items: products.Product[] }) {
  return (
    <div className="mx-auto">
      ...
      >
        <h1 className="uppercase text-3xl sm:text-6xl">New Collections</h1>
        <p className="text-sm sm:text-base mx-auto px-8 sm:max-w-[50%] my-10">
          a NFTs Collections represents a cutting-edge frontier in digital art
          and collectibles, embodying the latest trends and innovations in the
          rapidly evolving world of non-fungible tokens
        </p>
      </div>
      {items.length ? (
        <div
