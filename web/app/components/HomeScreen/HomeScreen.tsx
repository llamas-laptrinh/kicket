  ...
  return (
    <div className="mx-auto relative">
      <div className="relative">
        <div className="flex sm:flex-row flex-col bg-zinc-900">
          <div className="basis-1/2 text-center sm:text-left relative">
            ...
            >
              ...
              <h3 className="text-base sm:text-2xl py-6">
                Join the community {''}
                {/* <span className="text-purple-500">KICKET</span> */}
              </h3>
          ...
          <div className="basis-1/2">
            <video
              ...
              loop
              playsInline
              poster="https://image.mux.com/Xzu00BQCV449DpbnFb6o87Ljc68uWU7GCOz401RYqnPMY/thumbnail.jpg?auto=format&amp;dpr=1&amp;w=2560"
              className="w-full h-[450px] object-cover px-10 sm:px-0"
              width={1000}
              height={800}
            >
              <source
                src="https://stream.mux.com/Xzu00BQCV449DpbnFb6o87Ljc68uWU7GCOz401RYqnPMY/high.mp4"
                type="video/mp4"
              />
            </video>
            {/* <Image
        ...
        <Image
          className="absolute object-cover inset-x-2/4 -translate-x-2/4 -translate-y-[20%] bottom-0 top-[20%] hidden sm:block"
          src="/images/hero.png"
          alt="KICKET"
          width={202}
          height={245}
        ...
        <div className="flex gap-2 sm:gap-14 px-14 flex-col sm:flex-row">
          <div className="text-custom-1 text-center sm:text-left pt-10 sm:py-20 basis-1/2">
            ...
            <p className="text-lg my-10 text-black">
              Use your NFT as collateral to borrow crypto from lenders. Repay
              your loan, and you get your NFT back.
            </p>
            <a href="/shop" className="btn-main rounded text-base px-8 py-2.5">
              Explore Now
            </a>
      ...
      <div className="bg-zinc-900 text-site pt-16 mt-12 sm:p-20">
        <div className="flex gap-6">
          <div className="basis-1/2">
            ...
            <p className="text-lg my-10">
              Membership, Loyalty services. Simplified <br /> Unlock the power
              of blockchain to transform your business with secure, transparent,
